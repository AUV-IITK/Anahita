...
void vision_commons::Morph::open(cv::Mat &raw, int element_size, int element_centerX, int element_centerY, int iterations)
{
...
void vision_commons::Morph::close(cv::Mat &raw, int element_size, int element_centerX, int element_centerY, int iterations)
{
  cv::Mat opening_closing_kernel = cv::getStructuringElement(cv::MORPH_ELLIPSE, cv::Size(element_size, element_size), cv::Point(element_centerX, element_centerY));
