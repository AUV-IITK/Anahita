 ...
 * @brief  This file provide some common algoriths to achieve color constancy like gray world,shades of gray in RGB and Lab Color space.
...
public:
  ...
  public:
    /** The main method called to perform color correction using modified contrast stretching The only input required is the input image
  ...
  public:
    ...
    /** function to estimate the illumination vector or scaling factor for RGB color space computation
